...
- [Attaching the agent hook](./getting-started/agent-hook.md)

# Daily use

- [The pre-edit card](./daily-use/pre-edit-card.md)
- [`abyss where`, `context`, `impact`](./daily-use/where-context-impact.md)
- [`abyss callers`](./daily-use/callers.md)
- [`abyss search`](./daily-use/search.md)

# Ambient mode

- [`abyss watch` (foreground)](./ambient/watch.md)
- [`abyss daemon start --detach` (background)](./ambient/daemon.md)
- [Socket protocol](./ambient/socket-protocol.md)

# Architecture

- [L0 architectural coordinates](./architecture/arch-layers.md)
- [Resolver tiers and confidence](./architecture/resolver-tiers.md)
- [Design principles](./architecture/principles.md)

# Eval

- [How resolution is measured](./eval/method.md)
