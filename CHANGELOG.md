...
| click 8.1.8 | Python | 98.7 / 94.6 | **97.9 / 93.0** | −0.8 / −1.6 |
...
Five corpora zero regression. Click is the outlier — single-language
Python project where cross-language filter doesn't fire, but the L0 +
codegen-aware skip work elsewhere in the pipeline shifted a handful of
refs between tiers (1.0: 189→178, 0.95: 333/6→348/11). Within engineering
noise on a 589-pair truth set; not release-blocking but logged here for
transparency.
